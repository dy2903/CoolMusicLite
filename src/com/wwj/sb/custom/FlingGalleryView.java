...
//		 the scrolled left position of this view
//		中间
...
//			初始化
	 ...
	 * This method is invoked by measure(int, int) and 
	 * should be overriden by subclasses to provide accurate and efficient measurement of their contents. 
 ...
 */
	 ...
	 * false，那么后续的move, up等事件将继续会先传递给该ViewGroup，
	 * 之后才和down事件一样传递给最终的目标view的onTouchEvent()处理。
	 * 如果该ViewGroup的onInterceptTouchEvent()在接收到down事件处理完成之后return
	 * true，那么后续的move,
...
//		 change has happened during a press gesture (between ACTION_DOWN and ACTION_UP).
